                                      ...
                                      else
                                      {
                                          ...
                                          switch (error.code) {
                                              ...
                                              case LAErrorAuthenticationFailed: // when TouchID max retry is reached, fallbacks to passcode
                                                  [[[UIAlertView alloc] initWithTitle:@"AuthenticationFailed"
                                                                              message:@""
                                                                             delegate:nil
                                              ...
                                              case LAErrorUserCancel:
                                                  ...
                                                  break;
                                                  \
                                              case -8: // when TouchID max retry is reached, fallbacks to passcode
                                                  [[[UIAlertView alloc] initWithTitle:@"Biometry is disabled"
                                                                              message:@"Biometry is disabled for unlock.Please try passcode to unlock"
                                                                             delegate:nil
                                                                    cancelButtonTitle:@"OK"
                                                                    otherButtonTitles:nil] show];
